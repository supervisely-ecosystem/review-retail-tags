...
def init():
    ...
    reference_path = os.environ["modal.state.referencePath"]
    _empty_string_error(reference_path, "path to file with references")
    sly.logger.info("reference_path", extra={"reference_path": reference_path})
